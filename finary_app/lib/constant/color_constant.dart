...
class MainColor {
  Color primaryBlue = const Color(0xff605DEC);
}

class StrokeColor {
  Color focused = const Color(0xfff845fc);
  Color grey = const Color(0xffbdbcdb);
}

class BackgroundColor {
  Color white = const Color(0xffffffff);
  Color whiteDisabled = const Color(0xffF4F3FE);
}

class TextColor {
  Color black = const Color(0xff212121);
  Color white = const Color(0xffEBEBEB);
  Color grey = const Color(0xff818181);
  Color lightGrey = const Color(0xffc9c8d3);
  Color disabled = const Color(0xffc5c0db);
}

class TextColorInterface {
  Color validation = const Color(0xff605dec);
  Color error = const Color(0xfff93232);
...
class ButtonPrimaryColor {
  ...
  Color bgDisabled = const Color(0xfff4f3fe);
